  ...
  return (
    <Tabs defaultValue="general" className="w-full">
      ...
      <TabsContent value="general" className="pt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <FormField {...formFieldProps} id="marital_status" label="الحالة الاجتماعية" type="select" options={[{value: 'أعزب', label: 'أعزب'}, {value: 'متزوج', label: 'متزوج'}, {value: 'مطلق ', label: ' مطلق'}, {value: ' أرمل ', label: ' أرمل'}]} />
      ...
      <TabsContent value="qualification" className="pt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
        <FormField {...formFieldProps} id="qualification" label="المؤهل الدراسي" />
      ...
      <TabsContent value="financial" className="pt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <FormField {...formFieldProps} id="current_financial_grade" label="الدرجة المالية الحالية" type="select" options={[{value: 'الأولى', label: 'الأولى'}, {value: 'الثانية', label: 'الثانية'}, {value: 'الثالثة', label: 'الثالثة'}, {value: 'الرابعة', label: 'الرابعة'}, {value: 'الخامسة', label: 'الخامسة'}, {value: 'السادسة', label: 'السادسة'}]} />
        <FormField {...formFieldProps} id="current_financial_grade_date" label="تاريخ الحصول عليها" type="date" />
        <FormField {...formFieldProps} id="previous_financial_grade" label="الدرجة المالية السابقة" type="select" options={[{value: 'الأولى', label: 'الأولى'}, {value: 'الثانية', label: 'الثانية'}, {value: 'الثالثة', label: 'الثالثة'}, {value: 'الرابعة', label: 'الرابعة'}, {value: 'الخامسة', label: 'الخامسة'}, {value: 'السادسة', label: 'السادسة'}]} />
      ...
      <TabsContent value="functional" className="pt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <FormField {...formFieldProps} id="job_on_cadre" label="الوظيفة على الكادر" />
        ...
        <FormField {...formFieldProps} id="contract_birth_date" label="تاريخ  التعاقد" type="date" />
